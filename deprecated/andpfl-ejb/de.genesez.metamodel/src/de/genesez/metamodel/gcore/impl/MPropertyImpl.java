 ...
 * <ul>
 *   <li>{@link de.genesez.metamodel.gcore.impl.MPropertyImpl#getVisibility <em>Visibility</em>}</li>
 *   <li>{@link de.genesez.metamodel.gcore.impl.MPropertyImpl#isDerived <em>Derived</em>}</li>
 *   <li>{@link de.genesez.metamodel.gcore.impl.MPropertyImpl#getMultiplicity <em>Multiplicity</em>}</li>
 *   <li>{@link de.genesez.metamodel.gcore.impl.MPropertyImpl#isUnique <em>Unique</em>}</li>
 *   <li>{@link de.genesez.metamodel.gcore.impl.MPropertyImpl#isOrdered <em>Ordered</em>}</li>
 *   <li>{@link de.genesez.metamodel.gcore.impl.MPropertyImpl#getClassifier <em>Classifier</em>}</li>
 *   <li>{@link de.genesez.metamodel.gcore.impl.MPropertyImpl#getGenericRealization <em>Generic Realization</em>}</li>
 *   <li>{@link de.genesez.metamodel.gcore.impl.MPropertyImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MPropertyImpl extends MElementImpl implements MProperty
{
  ...
  public EList getGenericRealization()
  {
    ...
    {
      genericRealization = new EObjectContainmentWithInverseEList(MGeneric.class, this, GcorePackage.MPROPERTY__GENERIC_REALIZATION, GcorePackage.MGENERIC__OWNING_PROPERTY);
    }
