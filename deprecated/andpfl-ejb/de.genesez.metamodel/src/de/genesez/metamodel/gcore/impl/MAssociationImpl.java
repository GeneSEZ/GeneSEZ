 ...
 * <ul>
 *   <li>{@link de.genesez.metamodel.gcore.impl.MAssociationImpl#isDerived <em>Derived</em>}</li>
 *   <li>{@link de.genesez.metamodel.gcore.impl.MAssociationImpl#getEnd <em>End</em>}</li>
 *   <li>{@link de.genesez.metamodel.gcore.impl.MAssociationImpl#getOwningPackage <em>Owning Package</em>}</li>
 *   <li>{@link de.genesez.metamodel.gcore.impl.MAssociationImpl#getAssociationClass <em>Association Class</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MAssociationImpl extends MElementImpl implements MAssociation
{
  ...
  public EList getEnd()
  {
    if (end == null)
    {
      end = new EObjectWithInverseResolvingEList(MAssociationRole.class, this, GcorePackage.MASSOCIATION__END, GcorePackage.MASSOCIATION_ROLE__ASSOCIATION);
    }
    return end;
  }
