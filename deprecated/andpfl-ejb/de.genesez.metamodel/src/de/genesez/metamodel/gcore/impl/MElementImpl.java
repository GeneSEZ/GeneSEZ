 ...
 * <ul>
 *   <li>{@link de.genesez.metamodel.gcore.impl.MElementImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.genesez.metamodel.gcore.impl.MElementImpl#getXmiGuid <em>Xmi Guid</em>}</li>
 *   <li>{@link de.genesez.metamodel.gcore.impl.MElementImpl#getOwnedComment <em>Owned Comment</em>}</li>
 *   <li>{@link de.genesez.metamodel.gcore.impl.MElementImpl#getTaggedValue <em>Tagged Value</em>}</li>
 *   <li>{@link de.genesez.metamodel.gcore.impl.MElementImpl#getStereotype <em>Stereotype</em>}</li>
 *   <li>{@link de.genesez.metamodel.gcore.impl.MElementImpl#getAspect <em>Aspect</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class MElementImpl extends EObjectImpl implements MElement
{
  ...
  public EList getOwnedComment()
  {
    ...
    {
      ownedComment = new EObjectContainmentWithInverseEList(MComment.class, this, GcorePackage.MELEMENT__OWNED_COMMENT, GcorePackage.MCOMMENT__OWNING_ELEMENT);
    }
    return ownedComment;
  }
  ...
  public EList getTaggedValue()
  {
    if (taggedValue == null)
    {
      taggedValue = new EObjectContainmentWithInverseEList(MTaggedValue.class, this, GcorePackage.MELEMENT__TAGGED_VALUE, GcorePackage.MTAGGED_VALUE__OWNING_ELEMENT);
    }
    return taggedValue;
  }
  ...
  public EList getStereotype()
  {
    if (stereotype == null)
    {
      stereotype = new EObjectResolvingEList(MStereotype.class, this, GcorePackage.MELEMENT__STEREOTYPE);
    }
    return stereotype;
  }
  ...
  public EList getAspect()
  {
    if (aspect == null)
    {
      aspect = new EObjectContainmentWithInverseEList(MAspect.class, this, GcorePackage.MELEMENT__ASPECT, GcorePackage.MASPECT__ELEMENT);
    }
    return aspect;
  }
