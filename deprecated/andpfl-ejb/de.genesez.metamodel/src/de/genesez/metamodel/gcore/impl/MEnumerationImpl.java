 ...
 * <ul>
 *   <li>{@link de.genesez.metamodel.gcore.impl.MEnumerationImpl#getLiteral <em>Literal</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MEnumerationImpl extends MDataTypeImpl implements MEnumeration
{
  ...
  public EList getLiteral()
  {
    if (literal == null)
    {
      literal = new EObjectContainmentWithInverseEList(MLiteral.class, this, GcorePackage.MENUMERATION__LITERAL, GcorePackage.MLITERAL__OWNING_ENUMERATION);
    }
    return literal;
  }
