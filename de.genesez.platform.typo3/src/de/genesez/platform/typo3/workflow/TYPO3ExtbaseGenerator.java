 ...
 * @date 2011-04-13
 */
public class TYPO3ExtbaseGenerator extends Generator {
	...
	static {
		defaults.put("template", "de::genesez::platform::typo3::extbase::templates::Root::Root");
		defaults.put("typeMappingFile", "de/genesez/platform/typo3/extbase/typemapping/typemapping.xml");
