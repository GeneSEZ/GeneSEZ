 ...
 * @date 2011-07-18
 */
public class TYPO3v4MVCDefaultDirectoryCreator extends XtendComponent {
	...
	static {
		defaults.put("defaultDirectoryCreationScript", "de::genesez::platform::typo3v4::mvc::scripts::DefaultDirectoryCreation::createDefaultDirectories");
	 ...
	 * the parameter.
	 */
	public TYPO3v4MVCDefaultDirectoryCreator() {
		super();
