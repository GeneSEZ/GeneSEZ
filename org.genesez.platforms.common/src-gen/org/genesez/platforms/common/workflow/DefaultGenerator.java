...
import org.genesez.platforms.common.workflow.feature.FolderDeletionFeature;
import java.util.Properties;
import org.eclipse.emf.mwe.core.issues.Issues;
import org.genesez.platforms.common.workflow.feature.FileDeletionFeature;
import org.genesez.platforms.common.m2t.ImportBeautifier;
import org.genesez.platforms.common.workflow.feature.FileTreeWalkerFeature;
import org.eclipse.emf.mwe.core.monitor.ProgressMonitor;
import org.genesez.platforms.common.typemapping.TypeMapper;
...
public class DefaultGenerator extends Generator {
	...
	protected void checkConfigurationInternal(Issues issues) {
		...
		if (importTakeOver) {
			if (this.importBeautifier.getOptions().getProperty("de.genesez.importformatter.regex", "").isEmpty()) {
				logger.error("No import string given, imports cannot be carried over.");
			}
			if (this.importBeautifier.getOptions().getProperty("de.genesez.importbeautifier.fileextensions", "").isEmpty()) {
	 ...
	 * 
	 * @see org.genesez.platforms.common.m2t.ImportBeautifier#setImportStrings(String)
	 ...
	 * @see org.genesez.platforms.common.m2t.ImportBeautifier#setImportRegex(String)
