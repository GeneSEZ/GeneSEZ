...
import org.genesez.eclipse.wizard.ui.ChooseWorkflowPart;
import org.genesez.eclipse.wizard.ui.WorkflowFilePart;
...
public class GeneSEZProjectWizardWorkflowPage extends GeneSEZProjectWizardPage {
	...
	protected MUIElement createModel() {
		...
		chooseWorkflow
				.setContributionURI("bundleclass://org.genesez.eclipse/org.genesez.eclipse.wizard.ui.ChooseWorkflowPart");
		workflowFile
				.setContributionURI("bundleclass://org.genesez.eclipse/org.genesez.eclipse.wizard.ui.WorkflowFilePart");
		return pStack;
	}
