...
public class FileSystemHelper {
	...
	/**
	 * Creates a directory with the specified directory path name, including all necessary but nonexistent parent directories.
	 *
	 * @param	directoryPathName	The directory path name.
	 * @return	True if and only if the directory was created, along with all necessary parent directories, otherwise false.
	 */
	public static boolean createDirectoryPath(String directoryPathName) {
