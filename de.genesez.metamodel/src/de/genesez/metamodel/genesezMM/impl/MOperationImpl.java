 ...
 * <ul>
 *   <li>{@link de.genesez.metamodel.genesezMM.impl.MOperationImpl#getVisibility <em>Visibility</em>}</li>
 *   <li>{@link de.genesez.metamodel.genesezMM.impl.MOperationImpl#isStatic <em>Static</em>}</li>
 *   <li>{@link de.genesez.metamodel.genesezMM.impl.MOperationImpl#isAbstract <em>Abstract</em>}</li>
 *   <li>{@link de.genesez.metamodel.genesezMM.impl.MOperationImpl#isFinal <em>Final</em>}</li>
 *   <li>{@link de.genesez.metamodel.genesezMM.impl.MOperationImpl#getMultiplicity <em>Multiplicity</em>}</li>
 *   <li>{@link de.genesez.metamodel.genesezMM.impl.MOperationImpl#isUnique <em>Unique</em>}</li>
 *   <li>{@link de.genesez.metamodel.genesezMM.impl.MOperationImpl#isOrdered <em>Ordered</em>}</li>
 *   <li>{@link de.genesez.metamodel.genesezMM.impl.MOperationImpl#getParameter <em>Parameter</em>}</li>
 *   <li>{@link de.genesez.metamodel.genesezMM.impl.MOperationImpl#getClassifier <em>Classifier</em>}</li>
 *   <li>{@link de.genesez.metamodel.genesezMM.impl.MOperationImpl#getGenericParameter <em>Generic Parameter</em>}</li>
 *   <li>{@link de.genesez.metamodel.genesezMM.impl.MOperationImpl#getRaisedException <em>Raised Exception</em>}</li>
 *   <li>{@link de.genesez.metamodel.genesezMM.impl.MOperationImpl#getReturnType <em>Return Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
