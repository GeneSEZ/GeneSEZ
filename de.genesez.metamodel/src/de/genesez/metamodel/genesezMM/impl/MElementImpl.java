 ...
 * <ul>
 *   <li>{@link de.genesez.metamodel.genesezMM.impl.MElementImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.genesez.metamodel.genesezMM.impl.MElementImpl#getXmiGuid <em>Xmi Guid</em>}</li>
 *   <li>{@link de.genesez.metamodel.genesezMM.impl.MElementImpl#getOwnedComment <em>Owned Comment</em>}</li>
 *   <li>{@link de.genesez.metamodel.genesezMM.impl.MElementImpl#getTaggedValue <em>Tagged Value</em>}</li>
 *   <li>{@link de.genesez.metamodel.genesezMM.impl.MElementImpl#getStereotype <em>Stereotype</em>}</li>
 *   <li>{@link de.genesez.metamodel.genesezMM.impl.MElementImpl#getAspect <em>Aspect</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class MElementImpl extends EObjectImpl implements MElement
{
  ...
  {
    return GenesezMMPackage.Literals.MELEMENT;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GenesezMMPackage.MELEMENT__NAME, oldName, name));
  }
  ...
  public void setXmiGuid(String newXmiGuid)
  {
    ...
    xmiGuid = newXmiGuid;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GenesezMMPackage.MELEMENT__XMI_GUID, oldXmiGuid, xmiGuid));
  }
  ...
  public EList getOwnedComment()
  {
    ...
    {
      ownedComment = new EObjectContainmentWithInverseEList(MComment.class, this, GenesezMMPackage.MELEMENT__OWNED_COMMENT, GenesezMMPackage.MCOMMENT__OWNING_ELEMENT);
    }
    return ownedComment;
  }
  ...
  public EList getTaggedValue()
  {
    if (taggedValue == null)
    {
      taggedValue = new EObjectContainmentWithInverseEList(MTaggedValue.class, this, GenesezMMPackage.MELEMENT__TAGGED_VALUE, GenesezMMPackage.MTAGGED_VALUE__OWNING_ELEMENT);
    }
    return taggedValue;
  }
  ...
  public EList getStereotype()
  {
    if (stereotype == null)
    {
      stereotype = new EObjectResolvingEList(MStereotype.class, this, GenesezMMPackage.MELEMENT__STEREOTYPE);
    }
    return stereotype;
  }
  ...
  public EList getAspect()
  {
    if (aspect == null)
    {
      aspect = new EObjectContainmentWithInverseEList(MAspect.class, this, GenesezMMPackage.MELEMENT__ASPECT, GenesezMMPackage.MASPECT__ELEMENT);
    }
    return aspect;
  }
  ...
  public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case GenesezMMPackage.MELEMENT__OWNED_COMMENT:
        return ((InternalEList)getOwnedComment()).basicAdd(otherEnd, msgs);
      case GenesezMMPackage.MELEMENT__TAGGED_VALUE:
        return ((InternalEList)getTaggedValue()).basicAdd(otherEnd, msgs);
      case GenesezMMPackage.MELEMENT__ASPECT:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case GenesezMMPackage.MELEMENT__NAME:
        return getName();
      case GenesezMMPackage.MELEMENT__XMI_GUID:
        return getXmiGuid();
      case GenesezMMPackage.MELEMENT__OWNED_COMMENT:
        return getOwnedComment();
      case GenesezMMPackage.MELEMENT__TAGGED_VALUE:
        return getTaggedValue();
      case GenesezMMPackage.MELEMENT__STEREOTYPE:
