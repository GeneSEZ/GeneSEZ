...
import de.genesez.metamodel.genesezMM.GenesezMMFactory;
...
import de.genesez.metamodel.genesezMM.MAttribute;
...
import de.genesez.metamodel.genesezMM.MDataType;
...
import de.genesez.metamodel.genesezMM.MInterface;
...
import de.genesez.metamodel.genesezMM.MPointcut;
 ...
 * @generated
 */
public class GenesezMMPackageImpl extends EPackageImpl implements GenesezMMPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.genesez.metamodel.genesezMM.GenesezMMPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private GenesezMMPackageImpl()
  {
    super(eNS_URI, GenesezMMFactory.eINSTANCE);
  }
   ...
   * @generated
   */
  public static GenesezMMPackage init()
  {
    if (isInited) return (GenesezMMPackage)EPackage.Registry.INSTANCE.getEPackage(GenesezMMPackage.eNS_URI);

    // Obtain or create and register package
    GenesezMMPackageImpl theGenesezMMPackage = (GenesezMMPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof GenesezMMPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new GenesezMMPackageImpl());

    isInited = true;

    // Create package meta-data objects
    theGenesezMMPackage.createPackageContents();

    // Initialize created meta-data
    theGenesezMMPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theGenesezMMPackage.freeze();

    return theGenesezMMPackage;
  }
   ...
   * @generated
   */
  public GenesezMMFactory getGenesezMMFactory()
  {
    return (GenesezMMFactory)getEFactoryInstance();
  }
