 ...
 * <ul>
 *   <li>{@link genesezMM.impl.MElementImpl#getName <em>Name</em>}</li>
 *   <li>{@link genesezMM.impl.MElementImpl#getXmiGuid <em>Xmi Guid</em>}</li>
 *   <li>{@link genesezMM.impl.MElementImpl#getOwnedComment <em>Owned Comment</em>}</li>
 *   <li>{@link genesezMM.impl.MElementImpl#getTaggedValue <em>Tagged Value</em>}</li>
 *   <li>{@link genesezMM.impl.MElementImpl#getStereotype <em>Stereotype</em>}</li>
 *   <li>{@link genesezMM.impl.MElementImpl#getAspect <em>Aspect</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
