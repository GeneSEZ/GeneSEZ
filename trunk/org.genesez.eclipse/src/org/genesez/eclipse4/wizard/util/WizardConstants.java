...
/**
 * Contains constants for the org.eclipse.genesez plugin.
 * Mainly in use with dependency injection to pass the right values to the receiver.
 * 
...
public class WizardConstants {
	...
	/** To determine the directory where the workflow will be stored as String (key == workflow.directory, valueType: {@link java.lang.String})*/
	...
	/** To determine the chosen template (key == template.selection, valueType: {@link org.genesez.eclipse4.wizard.util.TemplateConfigXml})*/
	public static final String TEMPLATE = "template.selection";
	
	/** To determine the current visible wizard page (key == current.wizard.page, valueType: {@link org.eclipse.jface.wizard.IWizardPage})*/
	public static final String CURRENT_PAGE = "current.wizard.page";
	
	/** To determine the chosen files for the application model (key == application.model.list, valueType: {@link java.util.Set<java.io.File>})*/
	...
	/** To determine root of the application model (key == application.model.root, valueType: {@link org.eclipse.core.runtime.IPath})*/
