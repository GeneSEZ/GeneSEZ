...
/*
        WhatAMessException.java
        generated @ 2007-05-15 18:38:01.250 CEST by georg
...
/* PROTECTED REGION ID(java.imports._mxnRngMCEdyxB6OTzxcZMQ) ENABLED START */
...
/**
        <!-- PROTECTED REGION ID(java.type.comment._mxnRngMCEdyxB6OTzxcZMQ) ENABLED START -->
        <!-- TODO put your type comment here [description + responsibility] -->
        <!-- PROTECTED REGION END -->

        @author                georg
        @version        2007-05-15 18:38:01.250 CEST
 */
public class WhatAMessException {
    ...
    /* PROTECTED REGION ID(java.impl._mxnRngMCEdyxB6OTzxcZMQ) ENABLED START */
