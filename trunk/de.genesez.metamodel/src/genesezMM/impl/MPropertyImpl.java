 ...
 * <ul>
 *   <li>{@link genesezMM.impl.MPropertyImpl#getVisibility <em>Visibility</em>}</li>
 *   <li>{@link genesezMM.impl.MPropertyImpl#isDerived <em>Derived</em>}</li>
 *   <li>{@link genesezMM.impl.MPropertyImpl#getMultiplicity <em>Multiplicity</em>}</li>
 *   <li>{@link genesezMM.impl.MPropertyImpl#isUnique <em>Unique</em>}</li>
 *   <li>{@link genesezMM.impl.MPropertyImpl#isOrdered <em>Ordered</em>}</li>
 *   <li>{@link genesezMM.impl.MPropertyImpl#getClassifier <em>Classifier</em>}</li>
 *   <li>{@link genesezMM.impl.MPropertyImpl#getGenericRealization <em>Generic Realization</em>}</li>
 *   <li>{@link genesezMM.impl.MPropertyImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
