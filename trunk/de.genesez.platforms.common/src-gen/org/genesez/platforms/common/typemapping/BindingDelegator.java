...
public class BindingDelegator {
	...
	public BindingDelegator(String bindingContextPath) {
		...
		try {
			...
			// on the save side
			Schema schema = SchemaFactory.newInstance(javax.xml.XMLConstants.W3C_XML_SCHEMA_NS_URI).newSchema(ClassLoader.getSystemResource("org/genesez/platforms/common/typemapping/typemapping.xsd"));
