...
import org.genesez.platforms.common.typemapping.TypeMapping;
...
public class BasicMappingTest {
	...
	/**
	 * Test method for
	 * {@link org.genesez.platforms.common.typemapping.TypeMapping#getMapping(de.genesez.metamodel.gcore.MType, java.lang.String)}.
	 */
	@Test
	...
	public void getExternalContextMapping() {
		...
		EasyMock.replay(externalMock);
		assertEquals(
				"de.genesez.platforms.java.umlsupport.associations.Association",
