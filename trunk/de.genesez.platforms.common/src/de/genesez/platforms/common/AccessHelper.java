...
public class AccessHelper {
	...
	/**
	 * getter for a classifier by it's full qualified name the full qualified
	 * name must start with a package in the specified list
	 * 
	...
	/**
	 * getter for a package by it's full qualified name the full qualified name
	 * must start with a package in the specified list
	 * 
	 * @param packages a list of packages
	...
	/**
	 * returns the package element specified as the first package in package
	 * path allows the possibility that a dot '.' is in the package name
	 * 
	...
	/**
	 * determines if the package specified with the package name is in the given
	 * list of packages
	 * 
	 * @param pkgs a list of packages
