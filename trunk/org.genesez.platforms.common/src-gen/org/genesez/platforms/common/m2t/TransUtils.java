...
import org.genesez.platforms.common.log.GenesezLogger;
import de.genesez.metamodel.gcore.MPackage;
import java.util.StringTokenizer;
import org.genesez.platforms.common.Conversion;
...
public class TransUtils {
	...
	public static java.util.List<MPackage> rejectIgnoredPackages(java.util.List<MPackage> packages, String ignoredPackages) {
		...
		// init logging
		GenesezLogger.selectLogger("org.genesez.platforms.common.m2t");
		// perform actions
