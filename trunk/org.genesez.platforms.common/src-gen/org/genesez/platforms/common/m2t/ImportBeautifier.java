...
import org.genesez.platforms.common.NotPreparedException;
import java.util.HashSet;
import org.genesez.platforms.common.FileTreeObserverAdapter;
...
public class ImportBeautifier extends FileTreeObserverAdapter implements PostProcessor {
	...
	public void setFileExtensions(String extension) {
		...
		if (extensionsRegex != null) {
			this.getOptions().setProperty("de.genesez.importbeautifier.fileextensions", ".*(" + regex + ")$");
		}
		/* PROTECTED REGION END */
	}
	...
	public void setImportRegex(String regex) {
		...
		if (importRegex != null) {
			this.getOptions().setProperty("de.genesez.importformatter.regex", regex);
		}
		/* PROTECTED REGION END */
	}
