...
/**
 * Singleton Implementierung einer Queue für Events. Events werden der Reihe nach
 * abgearbeitet.
 * Events können auch mit Verzögerung verschickt werden, um Timerfunktionalität
 * zu ermöglichen. Nach Ablauf der Verzögerungszeit werden diese Events auch in
 * die Event-Queue eingereiht.
 * @author georg beier
...
public class EventQueue {
     ...
     * @param ev das gesendete Event
     */
    protected static void queue(Event<?> ev) {
        if(theQ.stopProcessing) throw new RuntimeException("Event Queue terminated");
        theQ.put(ev);
    }
    
    /**
     * reiht ein zurückgestelltes Event am Anfang in die Event-Queue ein
     * @param ev das gesendete Event
     */
    ...
    /**
     * Legt einen Timer für ein verzögertes Event an, das nach der Verzögerungszeit
     * gesendet wird.
     * @param ev das gesendete Event
     * @param delay Verzögerungszeit in msec
    ...
    /**
     * Konstruktor ist protected, um Erzeugung ausserhalb der Klasse zu verhindern
     */
    ...
    /**
     * Event am Anfang der Queue einstellen und ggf. Abarbeitung der Queue starten
     * @param ev das Event
     */
    private synchronized void prepend(Event<?> ev) {
        events.add(0, ev);
        if( ! isProcessing) {
            notifyAll();
        }
...
//                stopProcessing = true;
    ...
    public static abstract class Event<EV> {
         ...
         */
        protected abstract EventReceiver<EV> getReceiver();
        /**
         * Eine identifizierende enum, mit der die Events in der Empfängerklasse einfach
         * in einem <CODE>switch(event.getEventId())</CODE>
         * Statement unterschieden werden können.
         */
        protected EV eventId;
        
        /**
         * initialisierender Konstruktor
         * @param id eindeutige Event ID für den <U>Typ</U> des Events
         */
        ...
        /**
         * Verschickt das Event asynchron, indem es in die Event-Queue eingereiht wird.
         */
        public void send() {
        ...
        /**
         * Stelle das Event zurück, indem es wieder am Anfang in die Event-Queue eingereiht wird.
         */
        public void defer() {
        ...
        /**
         * Verschickt das Event mit der angegebenen Verzögerungszeit.
         * Das sendende Objekt kann eine Referenz auf das erzeugte
         * Timer-Objekt speichern, damit es ggf. mit <CODE>cancel()</CODE>
         * gelöscht werden kann.
         * Dadurch kann das Event vor Zustellung abgefangen werden, beispielsweise
         * wenn eine Timeout-Bedingung nicht mehr benötigt wird.
         * @param delay Verzögerung in msec
         * @return
         */
        ...
        /**
         * Stellt ein Event ohne Verwendung der Event-Queue sofort zu. Ist i.A. nur
         * sinnvoll, wenn Sender und Empf�nger das gleiche Objekt sind, d.h. wenn
         * ein Objekt seine State Machine als Resultat einer Bedingungsprüfung in einen
         * Folgezustand weiterschalten will.
         */
