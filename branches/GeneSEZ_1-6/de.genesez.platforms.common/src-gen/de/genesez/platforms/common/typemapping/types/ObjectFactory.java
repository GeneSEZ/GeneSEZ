 ...
 * generated in the de.genesez.platforms.common.typemapping.types package. 
...
public class ObjectFactory {
    ...
    private final static QName _Context_QNAME = new QName("http://www.genesez.de/typemapping", "context");
    private final static QName _PrimitiveTypes_QNAME = new QName("http://www.genesez.de/typemapping", "primitiveTypes");
    private final static QName _Type_QNAME = new QName("http://www.genesez.de/typemapping", "type");
    private final static QName _Include_QNAME = new QName("http://www.genesez.de/typemapping", "include");
    private final static QName _MultiValuedTypes_QNAME = new QName("http://www.genesez.de/typemapping", "multiValuedTypes");
    private final static QName _ExternalTypes_QNAME = new QName("http://www.genesez.de/typemapping", "externalTypes");
    private final static QName _TypeMapping_QNAME = new QName("http://www.genesez.de/typemapping", "typeMapping");
    private final static QName _To_QNAME = new QName("http://www.genesez.de/typemapping", "to");
    private final static QName _MultiValuedType_QNAME = new QName("http://www.genesez.de/typemapping", "multiValuedType");
    private final static QName _Default_QNAME = new QName("http://www.genesez.de/typemapping", "default");
    private final static QName _File_QNAME = new QName("http://www.genesez.de/typemapping", "file");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: de.genesez.platforms.common.typemapping.types
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.genesez.de/typemapping", name = "context")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.genesez.de/typemapping", name = "primitiveTypes")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.genesez.de/typemapping", name = "type")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.genesez.de/typemapping", name = "include")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.genesez.de/typemapping", name = "multiValuedTypes")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.genesez.de/typemapping", name = "externalTypes")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.genesez.de/typemapping", name = "typeMapping")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.genesez.de/typemapping", name = "to")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.genesez.de/typemapping", name = "multiValuedType")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.genesez.de/typemapping", name = "default")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.genesez.de/typemapping", name = "file")
