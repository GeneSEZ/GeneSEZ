 ...
 * <ul>
 *   <li>{@link de.genesez.metamodel.gcore.impl.MAspectImpl#getDomain <em>Domain</em>}</li>
 *   <li>{@link de.genesez.metamodel.gcore.impl.MAspectImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.genesez.metamodel.gcore.impl.MAspectImpl#getElement <em>Element</em>}</li>
 *   <li>{@link de.genesez.metamodel.gcore.impl.MAspectImpl#getIntroduction <em>Introduction</em>}</li>
 *   <li>{@link de.genesez.metamodel.gcore.impl.MAspectImpl#getPointcut <em>Pointcut</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MAspectImpl extends EObjectImpl implements MAspect
{
  ...
  public EList getIntroduction()
  {
    ...
    {
      introduction = new EObjectContainmentWithInverseEList(MIntroduction.class, this, GcorePackage.MASPECT__INTRODUCTION, GcorePackage.MINTRODUCTION__ORIGIN);
    }
    return introduction;
  }
  ...
  public EList getPointcut()
  {
    if (pointcut == null)
    {
      pointcut = new EObjectContainmentWithInverseEList(MPointcut.class, this, GcorePackage.MASPECT__POINTCUT, GcorePackage.MPOINTCUT__ORIGIN);
    }
    return pointcut;
  }
