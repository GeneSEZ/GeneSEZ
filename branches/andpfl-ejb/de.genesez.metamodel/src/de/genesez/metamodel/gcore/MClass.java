 ...
 * <ul>
 *   <li>{@link de.genesez.metamodel.gcore.MClass#getOwnedAssociation <em>Owned Association</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.genesez.metamodel.gcore.GcorePackage#getMClass()
 * @model
 * @generated
 */
public interface MClass extends MClassifier
{
   ...
   * It is bidirectional and its opposite is '{@link de.genesez.metamodel.gcore.MAssociation#getAssociationClass <em>Association Class</em>}'.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see de.genesez.metamodel.gcore.GcorePackage#getMClass_OwnedAssociation()
  ...
  /**
   * Sets the value of the '{@link de.genesez.metamodel.gcore.MClass#getOwnedAssociation <em>Owned Association</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
