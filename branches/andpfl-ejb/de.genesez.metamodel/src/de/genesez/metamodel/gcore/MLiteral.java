 ...
 * <ul>
 *   <li>{@link de.genesez.metamodel.gcore.MLiteral#getOwningEnumeration <em>Owning Enumeration</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.genesez.metamodel.gcore.GcorePackage#getMLiteral()
 * @model
 * @generated
 */
public interface MLiteral extends MElement
{
   ...
   * It is bidirectional and its opposite is '{@link de.genesez.metamodel.gcore.MEnumeration#getLiteral <em>Literal</em>}'.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see de.genesez.metamodel.gcore.GcorePackage#getMLiteral_OwningEnumeration()
