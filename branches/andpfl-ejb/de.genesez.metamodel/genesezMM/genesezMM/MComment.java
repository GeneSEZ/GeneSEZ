 ...
 * <ul>
 *   <li>{@link genesezMM.MComment#getXmiGuid <em>Xmi Guid</em>}</li>
 *   <li>{@link genesezMM.MComment#getAnnotation <em>Annotation</em>}</li>
 *   <li>{@link genesezMM.MComment#getOwningElement <em>Owning Element</em>}</li>
 *   <li>{@link genesezMM.MComment#getNestedComment <em>Nested Comment</em>}</li>
 *   <li>{@link genesezMM.MComment#getNestingComment <em>Nesting Comment</em>}</li>
 * </ul>
 * </p>
 *
 * @see genesezMM.GenesezMMPackage#getMComment()
 * @model
 * @generated
 */
public interface MComment extends EObject
{
   ...
   * @see genesezMM.GenesezMMPackage#getMComment_XmiGuid()
   * @model required="true"
   * @generated
   */
  String getXmiGuid();
  ...
  /**
   * Sets the value of the '{@link genesezMM.MComment#getXmiGuid <em>Xmi Guid</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see genesezMM.GenesezMMPackage#getMComment_Annotation()
   * @model required="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link genesezMM.MComment#getAnnotation <em>Annotation</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * It is bidirectional and its opposite is '{@link genesezMM.MElement#getOwnedComment <em>Owned Comment</em>}'.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see genesezMM.GenesezMMPackage#getMComment_OwningElement()
   ...
   * It is bidirectional and its opposite is '{@link genesezMM.MComment#getNestingComment <em>Nesting Comment</em>}'.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see genesezMM.GenesezMMPackage#getMComment_NestedComment()
   * @see genesezMM.MComment#getNestingComment
   * @model type="genesezMM.MComment" opposite="nestingComment" containment="true"
   * @generated
   */
   ...
   * It is bidirectional and its opposite is '{@link genesezMM.MComment#getNestedComment <em>Nested Comment</em>}'.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see genesezMM.GenesezMMPackage#getMComment_NestingComment()
